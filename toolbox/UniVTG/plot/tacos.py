...
def plot_video(pred_json, gt_json, save_dir_i, fig_num=None, template=True):
    ...
    vid_exists = os.path.exists(os.path.join(video_path, pred_json['vid'] + '.avi'))
    if vid_exists:
        cap = cv2.VideoCapture(os.path.join(video_path, pred_json['vid'] + '.avi'))
...
if __name__ == "__main__":
    ...
    video_path="/Users/kevin/dataset/tacos/videos"
    gt_path="/Users/kevin/univtg/data/tacos/metadata/test.jsonl"

    dset_path="/Users/kevin/univtg/results/mr-tacos"
    checkpoint_dir="aio_unified_epo3__f10_b10g1_s0.5_0.1-slowfast_clip-clip-2023_05_28_19"
    json_file="best_tacos_val_preds_nms_thd_0.7.jsonl"
    
    # baseline
    base_checkpoint_dir = "/Users/kevin/univtg_baseline/moment_detr/results/tacos-video_tef-exp-2023_02_26_02_42_09"
    base_json_file = "best_tacos_val_preds.jsonl"
    ...
    save_dir = os.path.join(os.path.join('/Users/kevin/univtg/plot', 'tacos', checkpoint_dir))
